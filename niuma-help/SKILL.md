...
- **雇佣牛马** — 安装各类技能（Skills）和 MCP 服务器扩展 AI 能力
...
**官网**：https://niuma.limyai.com — 了解更多产品信息、下载最新版本。

> 注意：技能和 MCP 的安装入口统一叫「雇佣牛马」，不要使用"牛马市场"或"技能商店"等旧称。
...
| 技能、skill、安装、卸载、雇佣牛马、斜杠命令、MCP、服务器 | `references/skills-mcp.md` | 雇佣牛马、安装管理、MCP 服务器配置 |
...
**Q: 牛马AI 的官网是什么？**
→ 官网地址：https://niuma.limyai.com ，可以了解产品介绍、下载最新版本。
